...
//         <h4>{chapter.title || chapter.name}</h4>
//         <span>{isOpen ? "▲" : "▼"}</span>
//       </div>
...
//             <div className="assessment-header" onClick={toggleAssessment}>
//               🎯 Chapter Assessment
...
//   // Toggle chapter open/close
//   const toggleDropdown = () => {
//     if (!chapter.unlocked) return; // Prevent opening if chapter is locked
//     setIsOpen(!isOpen);
//     setSelectedModuleIndex(null); // Close any open module when closing the chapter
//     setIsAssessmentOpen(false); // Close assessment if chapter is closed
//   };
...
//   // Handle module click to expand content
//   const handleModuleClick = (index) => {
//     if (!chapter.unlocked || !chapter.modules[index].unlocked) return; // Prevent module click if locked
//     setSelectedModuleIndex(index === selectedModuleIndex ? null : index);
//   };
...
//   return (
//     <div className={`chapter-container ${chapter.unlocked ? "" : "locked"}`}>
//       {/* Chapter Header */}
//       <div
//         className={`chapter-header ${chapter.unlocked ? "" : "locked"}`}
...
//               <div
//                 key={idx}
//                 className={`module-item ${module.unlocked ? "" : "locked"}`}
//               >
//                 <div
//                   className={`module-header ${module.unlocked ? "" : "locked"}`}
//                   onClick={() => handleModuleClick(idx)}
//                 >
//                   📚 {module.name || module.title}
//                   <span>{selectedModuleIndex === idx ? "▲" : "▼"}</span>
